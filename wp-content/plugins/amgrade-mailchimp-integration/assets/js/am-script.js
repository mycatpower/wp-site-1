(function ($) {
    $(document).ready(function() {
        ...
        body.on('submit', '.mc-subscribe', function(e) {
            ...
            if (!email) {
                submitted_form.append('<p class="error">' + appmc.no_exists + '</p>');
                return;
            }

            if (!validateEmail(email)) {
                submitted_form.append('<p class="error">' + appmc.invalid_email + '</p>');
                return;
            }
                ...
                success : function( response, textStatus, jqXHR) {
                    if (response.success) {
                        ...
                        if (response.status === 'empty key') {
                            ...
                            submitted_form.append('<p class="error">' + appmc.subscribe_error + '</p>');
