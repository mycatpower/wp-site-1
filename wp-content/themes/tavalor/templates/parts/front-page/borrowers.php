<?php
/**
 * Template part for displaying borrowers block in front-page.php
 *
...
$bg_color = (get_sub_field('bg_color')) ? get_sub_field('bg_color') : '#cfd8dc';
?>
<div class="section section-bg" id="section3"
     style="
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-12 mr-auto">
                    <div class="section-block-img">
                        ...
                        <img src="<?php echo get_template_directory_uri() ?>/resources/assets/images/fourth-block.png" alt="">
