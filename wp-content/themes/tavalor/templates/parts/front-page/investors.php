<?php
/**
 * Template part for displaying investors block in front-page.php
 *
...
$bg_color = (get_sub_field('bg_color')) ? get_sub_field('bg_color') : '#c5cae9';
?>
<div class="section section-bg" id="section2"
     style="
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-12 ml-auto">
                    <div class="section-block-img">
                        ...
                        <img src="<?php echo get_template_directory_uri() ?>/resources/assets/images/third-block.png" alt="">
